  ...
  <!-- Header -->
   ...
   <section class="hero-section" id="home">
    <div class="hero-content">
     <h2 id="hero-title">Make Every Moment Special</h2>
     <p id="hero-subtitle">Discover the perfect gifts, flowers, and surprises for your loved ones</p><a href="U_OrderForm.php" class="cta-button" id="cta-button">Order Now</a>
    </div>
    </section>
        ...
        <div class="products-grid">
            <div class="product-card">
                <div class="product-image">
                    <img src="https://picsum.photos/400/300?random=1" alt="Red Rose Bouquet" class="product-image-img">
                </div>
                <div class="product-info">
                    <h3>Red Rose Bouquet</h3>
                    <p class="product-description">Classic half dozen red roses</p>
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://picsum.photos/400/300?random=2" alt="Luxury Gift Box" class="product-image-img">
                </div>
                <div class="product-info">
                    <h3>Luxury Gift Box</h3>
                    <p class="product-description">Premium assorted chocolates</p>
                    <div class="product-footer">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://picsum.photos/400/300?random=3" alt="Celebration Balloons" class="product-image-img">
                </div>
                <div class="product-info">
                    <h3>Celebration Balloons</h3>
                    <p class="product-description">Colorful balloon bouquet</p>
                    <div class="product-footer">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://picsum.photos/400/300?random=4" alt="Spring Flower Mix" class="product-image-img">
                </div>
                <div class="product-info">
                    <h3>Spring Flower Mix</h3>
                    <p class="product-description">Seasonal fresh flowers</p>
                    <div class="product-footer">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://picsum.photos/400/300?random=5" alt="Memory Box Set" class="product-image-img">
                </div>
                <div class="product-info">
                    <h3>Memory Box Set</h3>
                    <p class="product-description">Personalized keepsake box</p>
                    <div class="product-footer">
                        <span class="product-price">₱148.00</span> 
                        <button class="add-to-cart">Add to Cart</button>
                    </div>
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="https://picsum.photos/400/300?random=6" alt="Surprise Package" class="product-image-img">
                </div>
                <div class="product-info">
                    <h3>Surprise Package</h3>
                    <p class="product-description">Mystery gift selection</p>
                    <div class="product-footer">
...
<!-- Promo Banner -->
   <section class="promo-section">
    <div class="promo-content">
     ...
     <h3 id="promo-title">Get 25% Off Your First Order!</h3>
     <p id="promo-subtitle">Use code: LYNX25 at checkout</p><button class="promo-button" id="promo-button">Shop Now</button>
    </div>
    ...
    <div class="categories-content">
     ...
     <div class="categories-grid">
      <div class="category-card">
       ...
       <h3>Gifts</h3>
       <p>Thoughtful presents for every occasion</p>
      </div>
      <div class="category-card">
       <div class="category-icon">
        🌸
       ...
       <h3>Flowers</h3>
       <p>Beautiful blooms to brighten any day</p>
      </div>
      <div class="category-card">
       <div class="category-icon">
        🎀
       ...
       <h3>Souvenirs</h3>
       <p>Memorable keepsakes and treasures</p>
      </div>
      <div class="category-card">
       <div class="category-icon">
        🎈
       ...
       <h3>Balloons</h3>
       <p>Festive decorations for celebrations</p>
      </div>
      <div class="category-card">
       <div class="category-icon">
        ✨
       ...
       <h3>Surprises</h3>
       <p>Unique items to delight and amaze</p>
      </div>
     </div>
    </div>
   ...
   <section class="contact-section" id="contact">
    <div class="contact-content">
     ...
     <p id="contact-subtitle">Have questions? We'd love to hear from you!</p>
